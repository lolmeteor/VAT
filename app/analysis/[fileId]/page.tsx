...
const analysisTypes = [
  { id: "kp", label: "КП (Ключевые пункты)", description: "Выделение основных моментов разговора" },
  { id: "first_meeting", label: "Первая встреча", description: "Анализ первичного контакта с клиентом" },
  { id: "follow_up_meeting", label: "Повторная встреча", description: "Анализ последующих встреч" },
  { id: "protocol", label: "Протокол", description: "Структурированный протокол встречи" },
  {
    id: "speaker1_psycho",
